1.Install Java and JDK 8 and above, Set JAVA_HOME path as environment avriable
2.Download  Chromedriver.exe and set chromedriver path windows environment variable
3.Install Eclipse with Maven plugin
4.Unzip weather-report-comparator.zip/clone https://github.com/cgghali/weather-comparator.git
